  ...
  return (
    <CustomerShell>
      <main className="mx-auto max-w-4xl px-4 py-6 sm:px-6 sm:py-8">
        <Link to="/profile" className="mb-5 inline-flex items-center gap-2 text-sm font-black text-slate-500 transition hover:text-shopee-500"><ArrowLeft size={17} /> Back to profile</Link>
        <div className="grid overflow-hidden rounded-[32px] border border-orange-100 bg-white shadow-card lg:grid-cols-[.85fr_1.15fr]">
          <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-[#6e281c] p-6 text-white sm:p-9">
            ...
            <div className="relative">
              ...
              <h1 className="mt-2 text-3xl font-black tracking-tight">{accountMode ? "Reset account password" : "Reset withdrawal PIN"}</h1>
          ...
          <section className="p-5 sm:p-8 lg:p-10">
            ...
            <form className="mt-6 grid gap-4" onSubmit={submit}>
              ...
              <Button type="submit" loading={busy} disabled={!formIsValid} className="mt-2 h-12 w-full">{accountMode ? "Update account password" : "Reset withdrawal PIN"}</Button>
            </form>
          </section>
        </div>
      </main>
